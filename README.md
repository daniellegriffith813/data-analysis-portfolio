...
Portfolio of data analysis projects in R, including statistical modeling, data visualization, and reproducible research workflows.
...
The portfolio demonstrates experience with:
...
R script for cleaning and preprocessing provided birdsong dataset.

02_british_birdsong_cleaned.txt
Plain text output of the cleaned dataset.
...
03_cocktail_methods_pie.png
Pie chart visualization of cocktail preparation methods.
...
origin/destination continent distributions
...
continent flow heatmap

destination continent distributions
